...
* **eCommerce Document Processor** This is my current project for The C# Academy, is going to be a document processor, that intakes data to be seeded into the API, and will output to PDF and Azure blob.
* **Improving DSA / Problem Solving skills in leetcode** I am keeping consistent problem solving in leetcode to help myself focus on time / space complexity, and learn the most optimal DSA techniques in different situations. 
### Roadmap
